...
**Status: R006 ledger companion. The exact active pair remains `canon/activations/chapter-zero-r005.json` until R006 is publicly read back and its activation receipt is merged; `canon/states/chapter-zero-r006.json` is the machine-readable candidate authority.**
...
| Id | Kind | Status after R006 | Durable fact | First source |
|---|---|---|---|---|
...
| `orra-scrap` | object/route | TRANSFORMED | The pressure-copying scrap, already folded toward the wells, is now held by the nearest of the unmarked three; its direction can travel without Mara and still promises neither distance nor water. | c35449, c37680, c38913; transformed c42222; transferred c47771 |
